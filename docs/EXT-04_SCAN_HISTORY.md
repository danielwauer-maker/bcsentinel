...
- Page 53130 `DH Deep Scan Runs`
  ...
  - Keeps Run ID, Scan Date, Score, Checks Count, Issues Count, and Impact LCY in the main list.
  - Moves the old Headline field behind the primary columns as Technical Message.
...
- Completed scans with rating `critical` or critical issues display as Completed with critical findings.
...
- EXT-05: replace Impact LCY with complete currency-aware amount display and formatting.
