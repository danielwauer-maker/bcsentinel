...
DEFAULT_DASHBOARD_TRANSLATIONS = {
    ...
    "de": OrderedDict(
        [
            ...
            ("static_full_issue_list_helper", "Vollständige Fehlerliste aus dem bestehenden Dashboard-Payload"),
            ("static_free_issue_access_note", "Kostenloser Zugriff zeigt Schweregrad und Business Value, ohne geschützte Fehlerdetails offenzulegen."),
            ("premium_issue_details", "Premium-Fehlerdetails"),
            ("view_locked_details", "Gesperrte Details anzeigen"),
            ("view_details", "Details anzeigen"),
            ("issue_detail_description_locked", "Die detaillierte Beschreibung ist nach der Full Analysis verfügbar."),
            ("issue_detail_recommendation_locked", "Die Empfehlung wird nach der Full Analysis erzeugt."),
            ("issue_detail_score_impact_empty", "Score-Impact-Details erscheinen, sobald sie verfügbar sind."),
            ("issue_detail_business_impact_locked", "Business-Impact-Details sind für den aktuellen Zugriff geschützt."),
