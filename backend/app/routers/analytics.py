...
def _build_dashboard_payload(
    ...
    return {
        ...
        "subscription": {
            ...
            "period_end": product_access.get("subscription_end"),
            "period_end_bc": product_access.get("subscription_end_bc"),
            "subscription_end": product_access.get("subscription_end"),
            "subscription_end_bc": product_access.get("subscription_end_bc"),
            "dashboard_access_until": product_access.get("dashboard_access_until"),
            "dashboard_access_until_bc": product_access.get("dashboard_access_until_bc"),
            "issue_access_until": product_access.get("issue_access_until"),
            "issue_access_until_bc": product_access.get("issue_access_until_bc"),
